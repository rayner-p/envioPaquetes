...
a persistence unit "envioPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "envio\pom.xml":
...
artifact ("envio.war") is already built. You can build
